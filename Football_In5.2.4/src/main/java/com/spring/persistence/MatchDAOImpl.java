...
public class MatchDAOImpl implements MatchDAO{
	...
	public void win(String teamname) throws Exception {
		session.update(namespace + ".win", teamname);
	}

	@Override
	public void draw(String teamname) throws Exception {
		session.update(namespace + ".draw", teamname);
	}

	@Override
	public void lose(String teamname) throws Exception {
		session.update(namespace + ".lose", teamname);
	}
	...
	public void goals(int totalgoals, int goalconceded, String teamname) throws Exception {
		...
		paramMap.put("totalgoals", totalgoals);
		paramMap.put("goalconceded", goalconceded);
		paramMap.put("teamname", teamname);
		
		session.update(namespace + ".goals", paramMap);
	}
