...
alter table user add column manager boolean;
...
alter table matches add constraint home
foreign key(home) references team(teamname);

alter table matches add constraint atno
foreign key(away) references team(teamname);
);
