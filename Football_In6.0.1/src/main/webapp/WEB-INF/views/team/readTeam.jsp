			...
			<div class="" style="margin: 10px">
				<div class="card mb-3" style="text-align: center">
					...
					<div class="card-body">
						...
						<h5 class="card-title">전적: ${teamVO.win } / ${teamVO.draw } / ${teamVO.lose } (승/무/패)</h5>
						<h5 class="card-title">골득실: ${teamVO.totalgoals } / ${teamVO.goalconceded } / ${teamVO.totalgoals - teamVO.goalconceded } (득/실/득실차)</h5>
