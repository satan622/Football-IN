...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="" style="margin: 10px">
				...
				<div class="card mb-3" style="text-align: center">
					...
					<div class="card-body">
						...
						<h5 class="card-title">전적: ${home.win } / ${home.draw } / ${home.lose } (승/무/패)</h5>
						<h5 class="card-title">골득실: ${home.totalgoals } / ${home.goalconceded } / ${home.totalgoals - home.goalconceded } (득/실/득실차)</h5>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div style="margin-top:35%; margin-bottom:35%; text-align:center" >
					<div>
			...
			<div class="" style="margin: 10px">
				...
				<div class="card mb-3" style="text-align: center">
					...
					<div class="card-body">
						...
						<h5 class="card-title">전적: ${away.win } / ${away.draw } / ${away.lose } (승/무/패)</h5>
						<h5 class="card-title">골득실: ${away.totalgoals } / ${away.goalconceded } / ${away.totalgoals - away.goalconceded } (득/실/득실차)</h5>
					</c:if>
				</div>
			</div>
		</div>
