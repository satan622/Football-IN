...
<body>
	...
	<div class="container">
		...
		<div class="div-footer">
			...
			<button type="submit" class="btn btn-outline-primary modifyBtn">Modify</button>
			<button type="submit" class="btn btn-outline-danger removeBtn">Remove</button>
			</c:if>
			<button type="submit" class="btn btn-outline-secondary goListBtn">List</button>
		</div>
		<hr>
				...
				<div class="box box-success">
					...
					<div class="box-body">
						<label for="newReplyWriter">Replyer</label> <input
							...
							id="newReplyWriter" readonly> <label for="newReplyText">Text</label>
		...
		<div class="row">
			<div class="container">
				<div class="box box-success">
					...
					<div class="box-body">
						<fieldset disabled>
							<label for="disabledInput">Replyer</label> 
							<input class="form-control" type="text" placeholder="Please Login" id="disabledInput">
							<label for="disabledInput">Text</label>
							<input class="form-control" type="text" placeholder="Please Login" id="disabledInput">
						</fieldset>
					</div>
