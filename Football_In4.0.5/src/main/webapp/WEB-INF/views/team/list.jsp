...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<c:if test="${not empty login }">
			<li id="teamcreate" class="list-inline-item" style="margin:20px">
				<a href="/team/create">
					<div class="card mb3" style="height:500px; text-align:center">
			...
			<c:forEach items="${list }" var="teamVO">
				<li class="list-inline-item" style="margin:20px">
					<div class="card mb3" style="height:500px; text-align:center">
						...
						<div class="card-body">
							<h5>지역: ${teamVO.location}</h5>
							<h5>인원: ${teamVO.people}</h5>
							<h5>창단일: <fmt:formatDate pattern="yyyy.MM.dd" value="${teamVO.regdate }" /></h5>
							<h5>관리자: ${teamVO.mid }</h5>
						</div>
					</div>
				</li>
			</c:forEach>
