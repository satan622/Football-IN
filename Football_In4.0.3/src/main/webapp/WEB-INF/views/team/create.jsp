			...
			<div class="row">
				...
				<div style="width: 40%">
					<div class="card mb-3">
						...
						<div class="card-body">
							<img
								style="height: 400px; width: 100%; display: block; border-radius: 50%;"
								id="emblem"
						...
						<div class="card-body">
							<div class="form-group">
								<label for="exampleInputFile">Input Image File</label> <input
									type="file" class="form-control-file" id="input_img" name="emblem"
				...
				<div class="row">
					<div class="col-6">
						<label for="exampleInputWriter">Team Leader ID</label><input
							type="text" name="mid" class="form-control" value="uid"
							readonly>
					</div>
					<div class="col-6">
