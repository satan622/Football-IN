...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<c:if test="${not empty login && empty login.team }">
				<li class="list-inline-item" style="margin:20px">
					<div id="teamcreate" class="card border-primary mb3" style="height:500px; text-align:center">
			...
			<c:forEach items="${list }" var="teamVO">
				<li class="list-inline-item" style="margin:20px"><a href="/team/readTeam${pageMaker.makeSearch(pageMaker.cri.page) }&tno=${teamVO.tno }">
					<div class="card mb3 teamcard" style="height:500px; text-align:center">
						...
						<div class="card-body">
							...
							<h5 class="card-title">창단일: <fmt:formatDate pattern="yyyy.MM.dd" value="${teamVO.regdate }" /></h5>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.card').on("mouseenter", function(){
			...
			$(this).attr("style", "height:500px; text-align:center; cursor:pointer");
		});
