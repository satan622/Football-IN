	...
	<div class="container">
		<div class="row">
			...
			<div class="btn-group btn-group-toggle" style="margin:20px;">
				<c:if test="${not empty login && login.manager == true }">
			...
			<table class="table table-hover" style="text-align:center">
				<thead>
					<tr>
						...
						<th style="width: 20%">Home & Away</th>
				...
				<c:forEach items="${list }" var="matchVO">
					<tr class="list">
						<td><span class="badge badge-primary badge-pill event">${matchVO.event}</span></td>
						<td>${matchVO.mno }</td>
						<td><span class="badge badge-pill badge-primary">${matchVO.home }</span> vs <span class="badge badge-pill badge-primary">${matchVO.away }</span></td>
						...
						<td><a class="btn btn-primary btn-sm" href="/matches/detail${pageMaker.makeQuery(pageMaker.cri.page) }&mno=${matchVO.mno }">Detail</a></td>						
					</tr>
				</c:forEach>
			</table>
		</div>
