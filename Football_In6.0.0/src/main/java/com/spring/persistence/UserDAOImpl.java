...
public class UserDAOImpl implements UserDAO {
	...
	@Override
	public void updateUserTeam(String uid, String teamname) throws Exception {
		Map<String, Object> paramMap = new HashMap<>();
		
		paramMap.put("uid", uid);
		paramMap.put("teamname", teamname);
		
		session.update(namespace + ".updateUserTeam", paramMap);
	}
	
	@Override
	public void manager(String uid) throws Exception {
		session.update(namespace + ".manager", uid);
	}
}