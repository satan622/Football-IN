...
<body>
	...
	<div class="container">
		...
		<ul class="timeline list-group">
			<!-- timeline time label	 -->
			<li class="time-label list-group-item d-flex justify-content-between" id="repliesDiv">Replies</li>
		</ul>
	...
	{{#each .}}
		<li class="replyLi list-group-item d-flex justify-content-between" data-rno={{rno}}>
			...
			<div>
				...
				<a class="btn btn-outline-secondary btn-sm" id="replyDelBtn">Remove</a>
			</div>
		</li>
	{{/each}}
</script>
