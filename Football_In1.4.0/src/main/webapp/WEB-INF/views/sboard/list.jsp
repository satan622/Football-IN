	...
	<div class="container">
		<nav class="navbar navbar-light bg-light">
			<select name="searchType" class="col-sm-2"
				...
				<button class="btn btn-primary my-2 my-sm-0" type="button">New Board</button>
		</nav>
...
// 	});
	...
	$(document).ready(function(){
		$('#searchBtn').on("click", function(event){
			self.location = "list" + '${pageMaker.makeQuery(1)}' + "&searchType=" + $("select oprion:selected").val() + "&keyword=" + encodeURIComponent($('#keywordInput').val());
		});
