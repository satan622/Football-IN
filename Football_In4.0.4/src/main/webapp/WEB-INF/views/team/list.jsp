		...
		<div class="table-responsive-lg">
			<table class="table table-hover" style="text-align:center">
				...
				<c:forEach items="${list }" var="teamVO">
					<tr>
						<td><img style="width:50px; height:50px" id="emblem" src="/displayFile?fileName=${teamVO.emblem }"></td>
						<td>${teamVO.teamname }</td>
						<td>${teamVO.location }</td>
						<td>${teamVO.mid }</td>
						<td>${teamVO.people }</td>
						<td style="text-align: right"><fmt:formatDate pattern="yyyy.MM.dd" value="${teamVO.regdate }" /></td>
					</tr>
				</c:forEach> 
			</table>
		</div>
